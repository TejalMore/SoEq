...
export class Config {
    ...
    'jhipster.mail.from' = 'SoEq@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'SoEq API';
    'jhipster.swagger.description' = 'SoEq API documentation';
    ...
    'eureka.instance.appname' = 'SoEq';
    'eureka.instance.instanceId' = 'SoEq:${random.value}';
